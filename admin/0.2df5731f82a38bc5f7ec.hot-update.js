...
var ProductPagePreview = function ProductPagePreview(_ref) {
  ...
  var bg = _this.props.getAsset(image);

  var entryTestimonials = entry.getIn(['data', 'testimonials']); // const testimonials = entryTestimonials ? entryTestimonials.toJS() : []

  var entryPricingPlans = entry.getIn(['data', 'pricing', 'plans']); // const pricingPlans = entryPricingPlans ? entryPricingPlans.toJS() : []
...
//# sourceMappingURL=0.2df5731f82a38bc5f7ec.hot-update.js.map